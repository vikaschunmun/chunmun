...
import 'package:chunmun/settings.dart';
...
//  final String channelName;
  ...
  const CallPage({Key key,this.friends}) : super(key: key);
...
class _CallPageState extends State<CallPage> {
  ...
  void initialize() {
    ...
    for (int i = 0; i < widget.friends.length; i++) {
      AgoraRtcEngine.joinChannel(null, widget.friends[i], null, 0);
    }
...
//          RaisedButton(child: Text("add new"),onPressed: () => Navigator.of(context).pushReplacement(MaterialPageRoute(
...
//                  context,
//                  MaterialPageRoute(
//                      builder: (context) => new CallPage(friends: addcall,
//                      )));
//
//            },child: Text("abc1")),
//          ),
